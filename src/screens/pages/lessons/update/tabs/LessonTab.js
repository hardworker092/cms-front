...
const LessonTab = () => {
    ...
    const { title, setTitle, desc, setDesc, author, setAuthor, authorList, teacher, setTeacher, teacherList } = useContext(LessonContext);
    ...
    return (
        <div className='flex flex-col w-full'>
            <div className='flex flex-row gap-x-2'>
                ...
                <CustomSelect onChange={(e) => setTeacher(e.target.value)} value={teacher} label={'نویسنده'}>
                    {
